...
<AccordionGroup>
  <Accordion title="Deterministic Security and Permission Boundaries" icon="sparkles">
    ### Problem in MCP
  ...
  <Accordion title="Secrets and Configuration Management" icon="sparkles">
    ### Problem in MCP
    ...
    Systems like molt.bot and clawd.bot move in a similar direction by
